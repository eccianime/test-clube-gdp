...
const Main =()=>(
	<Fragment>
		<Navigator />
		<Container><Row>
			<Col sm={12}><h2 className='text-center text-white m-5 supershadow'>Bem-vindo à minha prova...</h2></Col>
			<Col sm={12} className='mt-2 mb-2'>
					<Card className='p-3 text-white bg-dark-soft'>
						<Container fluid><Row>
							<Col sm={12} md={8}>
								<p className='text-justify'>Primeiro me apresento, meu nome é Jean Paul 
								...
								meu site onde poderá ver outros sites que eu tenho feito.</p>
							</Col>
							<Col sm={12} md={4}>
